...
//	@Indexed(unique=true)
	...
	public Pet(String id, String idUsuario, String imagen, String nombre, String idTipo, String genero,
			Date fechaNacimiento, String raza, String esterilizado, String color, String descripcion) {
		this.id = id;
	...
	public Pet(String idUsuario, String imagen, String nombre, String idTipo, String genero,
			Date fechaNacimiento, String raza, String esterilizado, String color, String descripcion) {
		this.idUsuario = idUsuario;
		this.imagen = imagen;
		this.nombre = nombre;
